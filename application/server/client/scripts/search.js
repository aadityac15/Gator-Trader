...
//          const x = createDomElement("FORM");
//          x.setAttribute("id", "myForm");
//          document.body.appendChild(x);
//
//          const messageInput = createDomElement("INPUT");
//          messageInput.setAttribute("type", "test");
//          document.getElementById("myForm").appendChild(messageInput);
//        };
